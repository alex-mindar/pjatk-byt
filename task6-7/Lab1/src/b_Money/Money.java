...
public class Money implements Comparable {
	...
	public String toString() {
		if (amount == 0) return String.format("%s.%s %s", 0, "00", getCurrency().getName());
		String amountStr = String.valueOf(amount);
		return String.format("%s.%s %s", amountStr.substring(0, amountStr.length() - 2), amountStr.substring(amountStr.length() - 2), getCurrency().getName());
	}
	...
	public Boolean equals(Money other) {
		return amount == currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
	}
	...
	public Money sub(Money other) {
		amount = amount - currency.valueInThisCurrency(other.getAmount(), other.getCurrency());
		return this;
	}
